...
from damoim_project.user.domain.model.serializer import (
    UserSerializer,
    CreateUserSerializer,
)
from damoim_project.libs.base.response import ReturnResponse
from damoim_project.libs.base.exceptions import (
    NotAuthenticated,
    ClientValueError,
...
class LogoutView(BaseModelViewSet):
    ...
    def post(self, request):
        try:
            ...
            return ReturnResponse(
                code="0000", flag=True, status=status.HTTP_205_RESET_CONTENT
            )
        except Exception as e:
            raise UnknownError
